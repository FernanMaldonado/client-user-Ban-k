...
import { Step1Deposito } from './Step1Deposito';
import { Step2Confirm } from './Step2Confirm';

export const DepositoWizard = () => {
    const { step, fetchMisCuentas, loadingCuentas } = useDepositoStore();
            ...
            <div className="p-12 pb-6 flex items-center justify-between border-b border-slate-100/50 bg-slate-50/50">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Servicio de Depositos</span>
                    </div>
                </div>
