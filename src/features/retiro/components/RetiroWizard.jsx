...
import { Step1Retiro } from './Step1Retiro';
import { Step2Confirm } from './Step2Confirm';

export const RetiroWizard = () => {
    const { step, fetchMisCuentas, loadingCuentas } = useRetiroStore();
        ...
        <div className="max-w-xl mx-auto w-full bg-white rounded-[3.5rem] shadow-2xl shadow-slate-300/50 overflow-hidden border border-slate-100">
            ...
            <div className="p-12 pb-6 flex items-center justify-between border-b border-slate-100/50 bg-slate-50/50">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Servicio de Retiros</span>
                    </div>
                </div>
            ...
            <div className="px-12 py-10 min-h-[400px]">
                {loadingCuentas ? (
                    ...
                    <>
                        <div className={step === 1 ? 'block' : 'hidden'}><Step1Retiro /></div>
                        {step === 2 && <Step2Confirm />}
                    </>
                )}
            </div>
